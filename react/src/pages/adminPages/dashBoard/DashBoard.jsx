      ...
      <div className="row">
        <div className="col-12 col-xl-6">
          <div className="dashbox">
            <div className="dashbox__title">
              <h3>
                <i className="ti ti-trophy"></i> Top items
              </h3>
        ...
        <div className="col-12 col-xl-6">
          <div className="dashbox">
            <div className="dashbox__title">
              <h3>
                <i className="ti ti-movie"></i> Latest items
              </h3>
        ...
        <div className="col-12 col-xl-6">
          <div className="dashbox">
            <div className="dashbox__title">
              <h3>
                <i className="ti ti-users"></i> Latest users
              </h3>
        ...
        <div className="col-12 col-xl-6">
          <div className="dashbox">
            <div className="dashbox__title">
              <h3>
                <i className="ti ti-star-half-filled"></i> Latest reviews
              </h3>
