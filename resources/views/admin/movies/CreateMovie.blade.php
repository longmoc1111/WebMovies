                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="sign__group">
                                        <input name="MovieName" type="text" class="sign__input" required placeholder="Tên phim">
                                    </div>
                                </div>

                                <div class="col-12">
                                    <div class="sign__group">
                                        <textarea name="MovieDescription" id="text" name="text" required class="sign__textarea"
                                            placeholder="Mô tả"></textarea>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="sign__group">
                                        <input name="MovieImage" type="url" required class="sign__input"
                                            placeholder="Link ảnh nền">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="sign__group">
                                        <input name="MovieYear" type="date" required class="sign__input">
                                    </div>
                                </div>
                            </div>
                        </div>
